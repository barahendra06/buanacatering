...
@section('main-content')
    <form method="post" action="{{ route('promo-update',['id' => $promo->id]) }}" enctype="multipart/form-data">
        {{ csrf_field() }}
        <div class="row">
            <div class="col-md-8">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Name</label>
                                    <input type="text" class="form-control" name="name" placeholder="Promo Name" id="" value="{{ $promo->name }}">
                                </div>
                            </div>
                             ...
                             <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="description" placeholder="Promo Description" id="" value="{{ $promo->description }}">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Url</label>
                                    <input type="text" class="form-control" placeholder="Url" name="url" id="" value="{{ $promo->url}}">
                                </div>
                            </div>
                                ...
                                <div class="form-group " id="">
                                    ...
                                    <select class="form-control" name="promo_type" id="" required>
                                        ...
                                        @foreach ($promoTypes as $promoType)
                                            <option value="{{ $promoType->id }}" {{ $promo->promo_type_id == $promoType->id ? 'selected' : '' }}>{{ $promoType->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class='input-group datetime'>
                                        <input name="start_date" autocomplete="off" value="{{$promo->start_date }}" type='text'
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class='input-group datetime'>
                                        <input autocomplete="off" name="end_date" value="{{ $promo->end_date }}" type='text'
