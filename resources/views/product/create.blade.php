            ...
            <div class="col-md-12">
                <div class="box box-default">
                    ...
                    <div class="box-body">
                        <div class="row">
                            <div class="col-md-12">
                                <form id="myForm" role="form" method="POST" enctype="multipart/form-data" action="{{ route('product-store') }}">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input class="form-control" type="text" name="product_name" placeholder="ex: Nasi Kuning" required>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input class="form-control" type="number" name="product_price" placeholder="ex: 10000" required>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input class="form-control" type="text" name="product_description" placeholder="ex: Nasi kuning adalah masakan khas jawa...." required>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="col-md-6">
                                                    <div class="form-group   ">
                                                        ...
                                                        <img class="img-preview" id="img-product-preview" width=270px height=190px
                    ...
                    $(".size_type option:selected").each(function() {
                        ...
                        if(counterSize == 0)
                        {
                            rowArticle = rowArticle + '<tr>' +
                                                        ...
                                                        '</td>' +
                                                        '<td>' +
                                                            '<input class="form-control articleVariant" type="text" name="description_article['+rowCounter+']" id="">' +
                                                        '</td>' +
                                                        '<td>' +
            ...
            else if(variantLength > 0 && sizeLength == 0)
            {
                $(".variant_type option:selected").each(function() {
                    ...
                    rowArticle = rowArticle + '<tr>' +
                                                ...
                                                '</td>' +
                                                '<td>' +
                                                    '<input class="form-control articleVariant" type="text" name="description_article[]" id="">' +
                                                '</td>' +
                                                '<td>' +
