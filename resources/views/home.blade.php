...
@push('html-header')
<meta name="description" content="Bu Ana Catering adalah catering terkenal di mojokerto, melayani catering segala events, corporate event, private event, wedding"/>
<meta name="keywords" content="catering,makanan,foods,buanacatering,events,dessert,wedding"/>
@endpush
...
@section('content')
    ...
    <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasNavbar" style="background-color:#6f0102;">

      <div class="offcanvas-header justify-content-between">
        <h4 class="fw-normal text-uppercase fs-6" style="color:white">Menu</h4>
      ...
      <div class="offcanvas-body">
        <ul class="navbar-nav justify-content-end menu-list list-unstyled d-flex gap-md-3 mb-0">
          ...
          <li class="nav-item border-dashed active d-lg-none d-block">
            <a href="{{ route('login') }}" class="nav-link d-flex align-items-center gap-3 text-dark p-2">
              <svg width="24" height="24" viewBox="0 0 24 24"><use xlink:href="#user"></use></svg>
              <span>Login</span>
            </a>
          </li>
          <li class="nav-item border-dashed active">
            <a href="#product_category_section" class="nav-link d-flex align-items-center gap-3 text-dark p-2">
              <svg width="24" height="24" viewBox="0 0 24 24"><use xlink:href="#package"></use></svg>
              <span>Product Category</span>
            </a>
          </li>
          <li class="nav-item border-dashed">
            <a href="#product_package_section" class="nav-link d-flex align-items-center gap-3 text-dark p-2">
          ...
          <li class="nav-item border-dashed">
            <a href="#product_category_{{ $productCategory->id }}_section" class="nav-link d-flex align-items-center gap-3 text-dark p-2">
    ...
    <header>
      <div class="container-fluid" style="background-color: #6f0102">
        <div class="row border-bottom">
            ...
            <div class="d-flex align-items-center my-3 my-sm-0">
              <a href="{{ route('home') }}" style="text-decoration: none">
                <div class="row d-md-block d-none">
                    <img src="img/logo.png" alt="logo" class="img" style="width: 120px!important">
                </div>
                <div class="row d-block d-md-none">
                  <h5>Bu Ana Catering</h5>
                </div>
              </a>
            </div>
            <button class="navbar-toggler" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasNavbar"
              aria-controls="offcanvasNavbar">
              <svg width="24" height="24" viewBox="0 0 24 24" style="color:white"><use xlink:href="#menu"></use></svg>
            </button>
          </div>
          ...
          <div class="col-sm-8 col-lg-2 gap-5 align-items-center justify-content-center justify-content-sm-end d-lg-block d-none">
            <ul class="d-flex justify-content-end list-unstyled m-0">
              <li style="margin-top:30px">
                <a href="{{ route('login') }}" class="p-2 mx-1">
                  <svg width="24" height="24" style="color:white"><use xlink:href="#user"></use></svg>
                </a>
              </li>
              {{-- <li>
    ...
    <section style="background-image: url('images/banner-1.jpg');background-repeat: no-repeat;background-size: cover;" id="about_section">
      <div class="container-lg">
        <div class="row">
          <div class="col-lg-6 pt-5 mt-5">
            <h2 class="display-1 ls-1"><span class="fw-bold text-primary" style="color:#6f0102!important">Bu Ana</span> <span class="fw-bold">Catering</span></h2>
            <p class="fs-4"><i>Your Trusted Catering Partner.</i> </p>
            ...
            <div class="row my-5">
              <div class="col">
                <div class="row text-dark">
                  <div class="col-auto"><p class="fs-1 fw-bold lh-sm mb-0">100+</p></div>
                  <div class="col"><p class="text-uppercase lh-sm mb-0">Food Varieties</p></div>
                </div>
              </div>
              <div class="col">
                <div class="row text-dark">
                  <div class="col-auto"><p class="fs-1 fw-bold lh-sm mb-0">250+</p></div>
                  <div class="col"><p class="text-uppercase lh-sm mb-0">Events Handled</p></div>
                </div>
              </div>
              <div class="col">
                <div class="row text-dark">
                  <div class="col-auto"><p class="fs-1 fw-bold lh-sm mb-0">2K+</p></div>
                  <div class="col"><p class="text-uppercase lh-sm mb-0">Customer</p></div>
                </div>
              </div>
            </div>
          </div>
              ...
              <div class="row">
                ...
                <div class="col-md-9">
                  <div class="card-body p-0">
                    <h5 class="text-light">Tailored to Your Taste</h5>
                    <p class="card-text">Custom menu for your needs and personal preferences.</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="col">
            <div class="card border-0 bg-secondary rounded-0 p-4 text-light">
              <div class="row">
                ...
                <div class="col-md-9">
                  <div class="card-body p-0">
                    <h5 class="text-light">Generous Foods</h5>
                    <p class="card-text">Match your favorite dishes in fair, satisfying portions.</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="col">
            <div class="card border-0 bg-danger rounded-0 p-4 text-light">
              <div class="row">
                ...
                <div class="col-md-9">
                  <div class="card-body p-0">
                    <h5 class="text-light">Free Tastings</h5>
                    <p class="card-text">Try our food before booking your special occasion.</p>
                  </div>
                </div>
              </div>
            </div>
    ...
    <section class="py-5 overflow-hidden" id="product_category_section">
      <div class="container-lg">
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="category-carousel swiper">
              <div class="swiper-wrapper">
                ...
                <a href="#" class="nav-link swiper-slide text-center">
                  <img src="{{ asset($productCategory->img_path) }}" class="rounded-circle" alt="Category Thumbnail">
                  <h4 class="fs-6 mt-3 fw-normal category-title">{{ $productCategory->name }}</h4>
                </a>
                @endforeach --}}
    ...
    <section class="pb-5" id="product_package_section">
      <div class="container-lg">
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="section-header d-flex flex-wrap justify-content-between my-4">
              ...
              <h2 class="section-title">Best Package</h2>
                ...
                <div class="product-item text-center">
                  <figure class="m-0 position-relative">
                    <a href="javascript:void(0)" 
                      ...
                      <!-- Hover overlay -->
                      <div class="overlay rounded-top-4 d-flex flex-column justify-content-center align-items-center text-white fw-semibold">
                        <span class="mb-2">Lihat Detail</span>
    ...
    @foreach($mappingProduct as $categoryName => $products)
    <section id="product_category_{{ $products->first()->catering_product_category_id }}_section" class="products-carousel " >
      <div class="container-lg overflow-hidden py-1" id="{{ $categoryName }}">
        <div class="row">
          <div class="col-md-12">
            <div class="section-header d-flex flex-wrap justify-content-between my-4">
                ...
                @foreach ($products as $product)
                  <div data-bs-toggle="modal"  data-bs-target="#productModal{{ $product->id }}"  height="250px" class="product-item swiper-slide"  title="{{ $product->description ?? 'Klik untuk lihat isi package' }}">
                    ...
                    <div class="d-flex flex-column text-center">
                      <h3 style="min-height:3rem!important" class="fs-6  fw-semibold  text-black product-desc">{{ $product->name }}</h3>
                       <div class="d-flex justify-content-center align-items-center gap-2">
                      @if($product->productVariants->count())
                      <span class="badge border border-dark-subtle rounded-0 text-dark fw-semibold">Start From {{ $product->productVariants->sortBy('price')->first()->product_price }}</span>
                      @else
                      <span class="badge border border-dark-subtle rounded-0 text-dark fw-semibold">{{ $product->product_price }}</span>
                      @endif
                    </div>
                    </div>
                  </div>
            ...
            <div class="row justify-content-center">
              <div class="col-md-5 p-3">
                <div class="section-header">
                  <h2 class="section-title display-5 text-light">Our Location</h2>
                </div>
                <p>
                  Visit our office at: 
                  <br>
                  Jl. Raya Suromurukan no. 65A, Surodinawan, Mojokerto
                </p>
                <br>
                <div class="section-header">
              ...
              <div class="col-md-5 p-3">
                <iframe 
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d301.1758449109647!2d112.41524280194275!3d-7.485427091030759!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e7812629a6cbbb3%3A0x543e4f9c4c636997!2sJl.%20Suromurukan%20Raya%20No.65%2C%20Mergelo%2C%20Surodinawan%2C%20Kec.%20Prajurit%20Kulon%2C%20Kota%20Mojokerto%2C%20Jawa%20Timur%2061328!5e0!3m2!1sen!2sid!4v1761066319976!5m2!1sen!2sid" 
                  width="100%" 
                  height="350" 
                  style="border:0;" 
                  allowfullscreen="" 
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 col-sm-6">
            <div class="footer-menu">
              <img src="img/logo.png" width="150" height="140" alt="logo">
              <div class="social-links mt-3">
                <ul class="d-flex list-unstyled gap-2">
                  <li>
                    <a href="https://www.facebook.com/BuAnaCatering/" class="btn btn-outline-light" target="_blank">
                  ...
                  <li>
                    <a href="https://www.instagram.com/buanaacatering/?hl=en" class="btn btn-outline-light" target="_blank">
          ...
          <div class="col-md-4 col-sm-6">
            <div class="footer-menu">
              <h5 class="widget-title">Bu Ana Catering</h5>
              <ul class="menu-list list-unstyled">
                <li class="menu-item">
                  <a href="#about_section" class="nav-link">About us</a>
                </li>
                <li class="menu-item">
                  <a href="#product_category_section" class="nav-link">Our Product Category</a>
                </li>
                <li class="menu-item">
                  <a href="#product_package_section" class="nav-link">Our Product Package</a>
                </li>
                <li class="menu-item">
                  <a href="#product_section" class="nav-link">Our Product</a>
                </li>
              </ul>
            </div>
          </div>
          <div class="col-md-2 col-sm-6">
            <div class="footer-menu">
              ...
              <ul class="menu-list list-unstyled">
                <li class="menu-item">
                  <a href="#contact_us_section" class="nav-link">Location</a>
                </li>
                <li class="menu-item">
                  <a href="#contact_us_section" class="nav-link">Contact Us</a>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-6 col-sm-6">
            <div class="footer-menu">
              ...
              <p style="color:white">Subscribe to our newsletter to get updates about our grand offers.</p>
...
@endsection
@section('content-body-scripts')
<script>
  document.addEventListener('DOMContentLoaded', function () {
    const offcanvasEl = document.getElementById('offcanvasNavbar');
    const offcanvas = bootstrap.Offcanvas.getOrCreateInstance(offcanvasEl);

    // Tangani klik pada semua link yang menuju section
    document.querySelectorAll('#offcanvasNavbar a[href^="#"]').forEach(link => {
      link.addEventListener('click', function (e) {
        ...
        if (targetEl) {
          ...
          // Scroll ke section setelah offcanvas selesai ditutup
